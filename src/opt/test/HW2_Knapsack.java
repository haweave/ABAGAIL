...
public class HW2_Knapsack {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < NUM_ITEMS; i++) {
            weights[i] = Math.round(random.nextDouble() * MAX_WEIGHT);
            volumes[i] = Math.round(random.nextDouble() * MAX_VOLUME);
        }
        ...
        StandardGeneticAlgorithm ga = new StandardGeneticAlgorithm(500, 300, 10, gap);
